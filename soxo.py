...
author: shuxiang29@gmail.com 我是坏淫!
license: GPL
version: 0.1beta
date: 2011.11.21
doc:
    ...
    开启debug可以使用静态文件来开发，并有简单的错误trace
    详细例子请看最下面的__main__里面的例子，谢谢
    开发时使用python soxo.py -e 应用模块.Soxo实例名 -h 0.0.0.0 -p 8080
            来启动开发服务器，可以自动重载修改过的模块，其中-h -p 不是必需的
            -h 默认localhost，-p默认9000
"""
